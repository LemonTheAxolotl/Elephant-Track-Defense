...
// Boss thresholds create a private 44-orb reinforcement set and stay immune until that exact set is gone.
...
assert.equal(run('phaseBoss.shieldReinforcementIds.length'),44);
