...
assert.equal(run('iceShieldVariants.every(orb=>orb.iceShieldChecked&&orb.iceShieldHits===2&&orb.iceShieldMaxHits===2)'),true);
...
assert.equal(run('state.balls.every(orb=>orb.iceShieldHits===2&&orb.iceShieldMaxHits===2&&!orb.snowCovered)'),true);
...
assert.equal(run('state.balls.every(orb=>orb.iceShieldHits===2&&orb.iceShieldMaxHits===2)'),true);
