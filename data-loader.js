(function(root){
  ...
  const VERSION='20260819-flame-trunk-tip-1';
  const SCRIPTS=['orb-progression.js','game.js','difficulty.js','currency.js','recovery.js','engineer-dig.js','content-runtime.js','map-system.js','snow-mutation.js','heater.js','flame-elephant.js'].map(path=>new URL(`${path}?v=${VERSION}`,document.baseURI).href);
