(function(root){
  ...
  const VERSION='20260813-frozen-puddles-1';
  const SCRIPTS=['orb-progression.js','game.js','difficulty.js','currency.js','recovery.js','engineer-dig.js','content-runtime.js','map-system.js'].map(path=>new URL(`${path}?v=${VERSION}`,document.baseURI).href);
