...
(function(root){
  ...
  function buyFlame(){if(state.status==='playing'&&state.currency>=definition.cost&&standardElephantCount()<CONFIG.ELEPHANT_LIMIT&&reservedTotalUnitCount()<CONFIG.TOTAL_UNIT_LIMIT){state.placement=TYPE;updateUI()}}
