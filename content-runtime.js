...
(function(root){
  ...
  const shopButtons={base:'#buyElephant',eyewear:'#buyEyewear',foodie:'#buyFoodie',gas:'#buyGasMask',frost:'#buyFrost',splash:'#buySplash',robot:'#buyRobot',papaya:'#buyPapaya',goldenPapaya:'#buyGoldenPapaya'};
